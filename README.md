...
Create a fork of my repository in your own GitHub account, and then ask Grok to customize it to your system, software, and user requirements. Be sure to instruct Grok to update everything in your new fork to reflect your changes.
